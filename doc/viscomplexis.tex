...
\begin{figure}[!htb]
  \centering
  \includegraphics[width = 0.9\linewidth]{../fig/plot-lexis_fx.pdf}
...
It is also possible to build a colour space on parameters relating to human colour perception. When asked to describe a colour it would be a remarkable feast for a person to express it in terms of the proportions of primary colours. Instead we tend to say that a colour is dark or bright (\emph{lightness}: \testclr{light1} \testclr{light2} \testclr{light3}), very pale or very pure (\emph{chroma}: \testclr{chroma1} \testclr{chroma2} \testclr{chroma3}) and tending to red, green, blue\ldots (\emph{hue}: \testclr{hue1} \testclr{hue2} \testclr{hue3}, see \cite{Fairchild2005} chapter 4 for colour terminology).
