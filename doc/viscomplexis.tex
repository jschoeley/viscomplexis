...
%\author{Jonas Schöley\footnote{The authors work has been funded by the Max Planck Society. Currently he is based in Warsaw as a student of the European Doctoral School of Demography (\texttt{schoeley@demogr.mpg.de}).} \and Frans Willekens\footnote{Chief Research Coordinator at the Max Planck Institute for Demographic Research in Rostock (\texttt{willekens@demogr.mpg.de}).}}
\date{\today}
...
\begin{figure}[!htb]
  \begin{subfigure}[t]{0.38\textwidth}
    ...
    \subcaption{The Lexis diagram: Relating Age, Period and Cohort on a plane.}
    \label{fig:lexis_exmpl}
  \end{subfigure}%
  ~
  \begin{subfigure}[t]{0.62\textwidth}
    \includegraphics[width = \textwidth]{../fig/plot-lexis_fx.pdf}
    \subcaption{The Lexis surface: Heatmap representation of demographic data structured by Age and Period/Cohort (simulated data).}
    \label{fig:lexis_fx}
  \end{subfigure}%
...
\begin{figure}[!htb]
  \begin{subfigure}[t]{0.65\textwidth}
    ...
    \subcaption{Proportion of people dying from a given cause by time and age (France, total population; Data: \textcite{Vallin2014}).}
    \label{fig:tbsplot}
    \end{subfigure}%
    ~
...
\begin{figure}[!htb]
  ...
  \caption{Qualitative-sequential-scheme: Share of people dying from the most prominent cause in a given time and age (France, total population; Data: \textcite{Vallin2014}).}
  \label{fig:qss}
\end{figure}
...
\begin{figure}[!htb]
  ...
  \caption{Age-wise-area-graph: Proportion of people dying from a given cause by time and age (France, total population; Data: \textcite{Vallin2014}).}
  \label{fig:aag}
\end{figure}
...
\begin{sidewaysfigure}[!htb]
  ...
  \caption{Small-multiples: Proportion of people dying from a given cause by time and age (France, total population; Data: \textcite{Vallin2014}).}
  \label{fig:smg}
\end{sidewaysfigure}
