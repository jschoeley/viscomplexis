...
%\institute{\includegraphics[width = 3cm]{./fig/EDSDLogo.pdf}}
...
\centering
\begin{subfigure}[c]{\textwidth}
\includegraphics[width = \textwidth]{./fig/spatial_map.pdf}
\end{subfigure}\\
\begin{subfigure}[c]{\textwidth}
\includegraphics[width = \textwidth]{./fig/temporal_map.pdf}
\end{subfigure}
\end{figure}
...
\begin{figure}[htb!]
\includegraphics[width = \textwidth]{./fig/binary.png} \\
